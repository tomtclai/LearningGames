...
public class StateChange {
	...
	public boolean puaseForAnimation = false;//Stores whether or not changes were made that require the game to puase for animation
	
	/**
	 * Will set given variables to defaults 
	 */
	...
	/**
	 * Will increment all of this rgis objects parameters and 
	 * @param other
	 */
