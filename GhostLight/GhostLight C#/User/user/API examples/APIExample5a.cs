 ...
 */
namespace user{
    public class APIExample5a : GhostFinderInterface {

        //Ussed to weed our redundant inputes
	    ...
	    public override void initialize() {
		    ...
		    InteractableObject[] iOset = new InteractableObject[20];
		    for(int loopX = 0; loopX < iOset.Length; loopX++){
			    iOset[loopX] = new InteractableObject();
		    }
		    objectGrid.setNumberOfRows(2);
		    objectGrid.setObjectGrid(iOset,0);
	    }
