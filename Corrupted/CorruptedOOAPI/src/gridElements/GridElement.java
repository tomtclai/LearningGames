...
//		textureList.put(ColorEnum.YELLOW, tempYellow);
	...
	protected static EnumMap<ColorEnum,BufferedImage> makeTextureMap(String r, String g, String b, 
			String c, String m, String y, float tintLevel)
{
EnumMap<ColorEnum,BufferedImage> textureList = new EnumMap<ColorEnum,BufferedImage>(ColorEnum.class);

//Create the buffered images needed
BufferedImage tintRed = BaseCode.resources.loadImage(r);
BufferedImage tintGreen = BaseCode.resources.loadImage(g);
BufferedImage tintBlue = BaseCode.resources.loadImage(b);
BufferedImage tintCyan = BaseCode.resources.loadImage(c);
BufferedImage tintMagenta = BaseCode.resources.loadImage(m);
BufferedImage tintYellow = BaseCode.resources.loadImage(y);

BufferedImage tempRed = ImageManip.tintedImage(tintRed, Color.red, tintLevel);
BufferedImage tempGreen = ImageManip.tintedImage(tintGreen, Color.green,tintLevel);
BufferedImage tempBlue = ImageManip.tintedImage(tintBlue, Color.blue, tintLevel);
BufferedImage tempCyan = ImageManip.tintedImage(tintCyan, Color.cyan, tintLevel);
BufferedImage tempMagenta = ImageManip.tintedImage(tintMagenta, Color.magenta, tintLevel);
BufferedImage tempYellow = ImageManip.tintedImage(tintYellow, Color.yellow, tintLevel);
