...
/**
 * This tower is a medic, which means that it has the ability to heal things.
 * @author Branden Drake
 * @author Rachel Horton
 */
public class TowerMedic extends Tower
{	
	public static final AnimationData ANIM_IDLE = new AnimationData("art/Characters/HTL_Wizard_Heal_Idle.png", 512, 512, 64, 64, 20, 30);
	public static final AnimationData ANIM_SELECTED = new AnimationData("art/Characters/HTL_Wizard_Heal_Selected.png", 512, 512, 64, 64, 20, 30);
	public static final AnimationData ANIM_DEATH = ANIM_SELECTED; // no death animations currently

	public static final String SOUND_SHOOT = "audio/sfx/healBuff.mp3";	
	
	public static final AnimationData EFFECT_SPELLCAST = new AnimationData("art/Characters/Spells/HTL_Spells_Healing.png", 1024, 1024, 200, 200, 25, 30);
	
	private static float castHealthAdjust = 10;
	private static float castSpeedAdjustDuration = 0;
	private static float castSpeedAdjustMultiplier = 1;
	
	private static Type towerType = Type.MEDIC;
	...
	public TowerMedic()
	{				
		projectileAnim = "olive.png";		//currently not used

		effectSpellcast = new EffectVisual(EFFECT_SPELLCAST, this.getCenterX(), this.getCenterY(), 4, 4);
